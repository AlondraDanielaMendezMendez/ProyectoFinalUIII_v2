...
class EmpleadosCopyWidget extends StatefulWidget {
  const EmpleadosCopyWidget({Key key}) : super(key: key);

  @override
  _EmpleadosCopyWidgetState createState() => _EmpleadosCopyWidgetState();
}

class _EmpleadosCopyWidgetState extends State<EmpleadosCopyWidget> {
